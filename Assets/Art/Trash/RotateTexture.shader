...
Shader "Custom/Trash/RotateTexture"
{
	Properties
	{
		...
		[ASEEnd]_Float0("Float 0", Float) = 1.54
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float cos9 = cos( _Float0 );
				float sin9 = sin( _Float0 );
				float2 rotator9 = mul( texCoord10 - _Vector0 , float2x2( cos9 , -sin9 , sin9 , cos9 )) + _Vector0;
				
				float3 Albedo = tex2D( _TextureSample0, rotator9 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord2.xy * float2( 5,5 ) + float2( 0,0 );
				float cos9 = cos( _Float0 );
				float sin9 = sin( _Float0 );
				float2 rotator9 = mul( texCoord10 - _Vector0 , float2x2( cos9 , -sin9 , sin9 , cos9 )) + _Vector0;
...
/*ASEBEGIN
Version=18912
0;448;1032;371;1210;-103.5;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-891,19.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;5,5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;11;-847,123.5;Inherit;False;Property;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0,0;3.65,-0.87;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;12;-795,286.5;Inherit;False;Property;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;1.54;1.54;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;9;-633,99.5;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;8;-349,83.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;ce30c4e7ef3dcfa4eb39200d051aed11;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-142,296.5;Inherit;False;Constant;_Float1;Float 1;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=49413A792781DE5C38065DF0982C8E597A82A455