...
Shader "Custom/VFX/CutoutParticle"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_PTex1("Particle Texture", 2D) = "white" {}
		[HDR]_HDRValue1("HDR Value", Color) = (0,0,0,0)
		[ASEEnd]_AlphaClip1("Alpha Clip", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_PTex1 = IN.ase_texcoord3.xy * _PTex1_ST.xy + _PTex1_ST.zw;
				float4 tex2DNode8 = tex2D( _PTex1, uv_PTex1 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( _HDRValue1 * ( tex2DNode8 * tex2DNode8.a ) ) * IN.ase_color ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_PTex1 = IN.ase_texcoord2.xy * _PTex1_ST.xy + _PTex1_ST.zw;
				float4 tex2DNode8 = tex2D( _PTex1, uv_PTex1 );
...
/*ASEBEGIN
Version=18912
0;431;1173;388;1313.846;65.20264;1.252859;True;False
Node;AmplifyShaderEditor.VertexColorNode;7;-791.264,-52.19604;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;8;-1707.205,21.96046;Inherit;True;Property;_PTex1;Particle Texture;0;0;Create;False;0;0;0;False;0;False;-1;None;0000000000000000f000000000000000;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-1126.765,-352.8528;Inherit;False;Property;_HDRValue1;HDR Value;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-673.9167,-296.7829;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-504.4372,-183.6499;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-1206.919,-11.07824;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-375.9704,243.8803;Inherit;False;Property;_AlphaClip1;Alpha Clip;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-565.2266,96.48227;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=CE14940203562ABD1BDB91D6C74BA4190244A20A