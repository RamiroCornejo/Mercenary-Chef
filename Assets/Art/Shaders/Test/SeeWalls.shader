...
Shader "SeeWalls"
{
	Properties
	{
		...
		[ASEBegin]_Float2("Float 2", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult11_g1 = (float2(_Float2 , _Float3));
				float temp_output_17_0_g1 = length( ( (( (ase_screenPosNorm).xy + _Vector0 )*2.0 + -1.0) / appendResult11_g1 ) );
				...
				float Occlusion = 1;
				float Alpha = ( 1.0 - saturate( ( ( 1.0 - temp_output_17_0_g1 ) / fwidth( temp_output_17_0_g1 ) ) ) );
...
/*ASEBEGIN
Version=18912
0;472;1023;347;982.1401;27.52163;1;True;False
Node;AmplifyShaderEditor.ScreenPosInputsNode;8;-1084.629,3.921634;Float;True;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;9;-926.8716,-87.77485;Inherit;False;True;True;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;15;-1015.158,257.9867;Inherit;False;Property;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;10;-511.3384,124.1531;Inherit;False;Property;_Float2;Float 2;0;0;Create;True;0;0;0;False;0;False;0;0.29;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-526.1401,185.4784;Inherit;False;Property;_Float3;Float 3;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-566.4849,46.25322;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;12;-323.6823,82.90601;Inherit;True;Ellipse;-1;;1;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0.5;False;9;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;13;-77.5,113;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-674.1945,171.9957;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TFHCRemapNode;16;-830.6478,221.6895;Inherit;False;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;0,1;False;3;FLOAT2;0,0;False;4;FLOAT2;0.5,-1.5;False;1;FLOAT2;0
...
WireConnection;12;7;10;0
WireConnection;12;9;18;0
WireConnection;13;0;12;0
WireConnection;17;1;16;0
WireConnection;16;0;15;0
WireConnection;1;6;13;0
ASEEND*/
//CHKSM=4E4D0D4E5BACB0EA5BDB2BAD48E978DAEECEF88F